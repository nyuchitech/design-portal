/**
 * Architecture seed data — initial data for seeding Supabase.
 *
 * This file is ONLY used by lib/db/seed.ts for the initial database seed.
 * The runtime source of truth is the database.
 * To update architecture data, update it in Supabase directly.
 */
