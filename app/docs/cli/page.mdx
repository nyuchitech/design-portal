...
The Nyuchi Design Portal is fully compatible with the **shadcn CLI**. You can install any of the **545 stable registry items** directly into your project with a single command.
