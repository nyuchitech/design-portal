...
export const metadata = {
  ...
  description:
    "Mukoko ecosystem architecture: local-first data strategy, cloud infrastructure, open data pipeline, and technology sovereignty.",
}
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-border">
              ...
              <tr>
                ...
                <td className="py-2 text-muted-foreground">
                  Architecture principles and framework decision
                </td>
              </tr>
              <tr>
                <td className="py-2 pr-4 font-mono text-xs">
                ...
                <td className="py-2 text-muted-foreground">
                  Local-first and cloud data layer specification
                </td>
              </tr>
              <tr>
                <td className="py-2 pr-4 font-mono text-xs">
